...
class productAdapter(private var context: Context) : RecyclerView.Adapter<productAdapter.viewHolder>() {
    ...
    class viewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        var img_sp : ImageView = view.findViewById(R.id.img)
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        holder.raiting.text = round(product.danhgia).toString()
