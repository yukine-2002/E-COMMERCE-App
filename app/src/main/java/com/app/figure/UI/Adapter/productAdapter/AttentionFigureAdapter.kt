...
class AttentionFigureAdapter( private val context: Context) :

    RecyclerView.Adapter<AttentionFigureAdapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.viewholder_figure,parent,false)
