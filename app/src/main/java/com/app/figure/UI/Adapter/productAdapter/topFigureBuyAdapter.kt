...
class topFigureBuyAdapter(private val context: Context) :
    RecyclerView.Adapter<topFigureBuyAdapter.viewHolder>() {
    ...
    class viewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        var raiting : RatingBar = view.findViewById(R.id.AVL_rating)
    ...
    override fun onBindViewHolder(holder: viewHolder, position: Int) {
        ...
        holder.raiting.rating = product?.danhgia ?: 5.0f
